...
def get_args_from_input():
	...
	parser.add_argument('--positional_encoding', type=str, help='type of positional encoding to use')
	parser.add_argument('--k', type=int, help='dimension of positional encoding')
	parser.add_argument('--dataset_name', type=str, help='name of dataset to use')
